...
const  Footer: React.FC = () => {
  ...
  return (
    <footer  footer className="bg-[#111827] text-white">
      <div className="max-w-[1280px] mx-auto px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          {/* Brand Column */}
          <div>
            <Link to="/" className="flex items-center gap-3 mb-6">
              <img src="/logo.png" alt="PlotFarm" className="h-10 w-auto brightness-0 invert" />
              <span className="font-fraunces text-2xl font-bold">PlotFarm</span>
            </Link>
            ...
            <ul className="space-y-4">
              ...
              <li>
                <a href="tel:+919876543210" className="flex items-center gap-3 font-manrope font-extralight text-[#9ca3af] text-sm hover:text-white transition-colors">
                  ...
                  <span>+91 7387xx89xx<br />
                   
                  </span>
                </a>
              </li>
              <li>
                <a href="mailto:krishnaagr218@gmail.com" className="flex items-center gap-3 font-manrope font-extralight text-[#9ca3af] text-sm hover:text-white transition-colors">
                  <Mail className="w-5 h-5 flex-shrink-0 text-[#D4755B]" />
                  <span>krishnaagr218@gmail.com<br />
        ...
        <div className="border-t border-[rgba(255,255,255,0.1)] pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="font-manrope font-extralight text-[#6b7280] text-sm text-center md:text-left">
              © 2026 PlotFarm. All rights reserved. Powered by AI.
            </p>
