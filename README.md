<img src="https://capsule-render.vercel.app/api?type=waving&color=0:15803D,100:4ADE80&height=220&section=header&text=PlotFarm&fontSize=80&fontColor=ffffff&fontAlignY=35&animation=fadeIn&desc=AI-Powered+Real+Estate+Platform&descAlignY=58&descSize=24" width="100%"/>

<div align="center">

  <img src="./frontend/Assets/Logo.svg" alt="PlotFarm Logo" height="80" />

<br/><br/>

[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=700&size=28&duration=3000&pause=1000&color=0:F97316,100:FB923&center=true&vCenter=true&width=700&lines=Find+Your+Dream+Home+%F0%9F%8F%A1;AI+Scrapes+99acres+in+Real-Time+%F0%9F%A4%96;Smart+Investment+Insights+%F0%9F%93%8A;30%2B+Indian+Cities+Covered+%F0%9F%87%AE%F0%9F%87%B3;Book+Appointments+Instantly+%F0%9F%93%85)](https://git.io/typing-svg)
...
[![Live Demo](https://img.shields.io/badge/%F0%9F%9A%80_Live_Demo-PlotFarm.vercel.app-4285F4?style=for-the-badge)](https://plotfarm.vercel.app)
[![Backend API](https://img.shields.io/badge/%E2%9A%99%EF%B8%8F_Backend_API-Render-46E3B7?style=for-the-badge)](https://plotfarm.onrender.com)

<br/>

[![Stars](https://img.shields.io/github/stars/krishna-Agrawal23/PlotFarm?style=social)](https://github.com/krishna-Agrawal23/PlotFarm)
[![Forks](https://img.shields.io/github/forks/krishna-Agrawal23/PlotFarm?style=social)](https://github.com/krishna-Agrawal23/PlotFarm/fork)
[![License](https://img.shields.io/github/license/krishna-Agrawal23/PlotFarm?color=green)](LICENSE)
[![Last Commit](https://img.shields.io/github/last-commit/krishna-Agrawal23/PlotFarm?color=orange)](https://github.com/krishna-Agrawal23/PlotFarm/commits)
[![Issues](https://img.shields.io/github/issues/krishna-Agrawal23/PlotFarm)](https://github.com/krishna-Agrawal23/PlotFarm/issues)
...
<div align="center">
  <img src="./Image/Home.png" alt="PlotFarm Homepage" width="100%" />
</div>
...
Most real-estate aggregators show you generic listings. PlotFarm is different:

| Problem | PlotFarm Solution |
|---|---|
...
<div align="center">
  <img src="./Image/aihub-0.png" alt="AI Hub - Location Trends" width="48%"/>
</div>
...
User's browser (localStorage)
  PlotFarm_github_key   = "ghp_xxx"
  PlotFarm_firecrawl_key = "fc-xxx"
         │
...
```bash
git clone https://github.com/krishna-Agrawal23/PlotFarm.git
cd Plot Farm
...
MONGO_URI=mongodb+srv://username:password@cluster.mongodb.net/PlotFarm?retryWrites=true&w=majority
JWT_SECRET=your_super_secure_jwt_secret_here  # Generate with: openssl rand -base64 32
ADMIN_EMAIL=admin@PlotFarm.com
...
### Live Deployments
- **🌐 Frontend**: [PlotFarm.vercel.app](https://plotfarm.vercel.app) (Vercel)
- **⚙️ Backend**: [PlotFarm-backend-zfu7.onrender.com](https://plotfarm.onrender.com) (Render)
...
[![Star](https://img.shields.io/github/stars/krishna-Agrawal23/PlotFarm?style=for-the-badge&logo=github&color=FFD700)](https://github.com/krishna-Agrawal23/PlotFarm)

</div>

<br/>

<img src="https://capsule-render.vercel.app/api?type=waving&color=0:1D4ED8,100:60A5FA&height=120&section=footer" width="100%"/>