      ...
      >
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-16">
            ...
            <div>
              <div className="text-xl font-bold text-[#FAF8F4]">PlotFarm</div>
        ...
        <div className="relative z-10 flex items-center gap-2 text-xs text-[#5A5856]">
          ...
          <span>Secured with 256-bit encryption • PlotFarm © 2025</span>
        </div>
      </motion.div>
      ...
      >
        <div className="w-full max-w-md">
          ...
          <div className="flex items-center gap-3 mb-10 lg:hidden">
            ...
            <div className="text-lg font-bold text-[#1C1B1A]">PlotFarm Admin</div>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="admin@plotfarm.com"
                  className={cn(
