...
export const createUserListing = async (req, res) => {
    try {
        ...
        const requiredFields = ['title', 'location', 'price', 'sqft', 'type', 'availability', 'description', 'phone'];
        
        // Only require beds and baths if the property is NOT a Plot
        if (type !== 'Plot') {
            requiredFields.push('beds', 'baths');
        }
