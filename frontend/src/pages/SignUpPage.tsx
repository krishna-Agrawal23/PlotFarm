  ...
  if (isSuccess) {
    return (
      <div className="min-h-screen bg-[#FAF8F4] flex items-center justify-center py-12 px-4">
        <div className="max-w-[520px] w-full text-center bg-white border border-[#E6E0DA] rounded-2xl p-8 shadow-xl">
          <CheckCircle className="w-16 h-16 text-[#D4755B] mx-auto mb-4" />
          <h2 className="font-syne font-bold text-2xl text-[#221410] mb-2">Account Created!</h2>
          <p className="font-manrope text-[#4B5563] mb-6">
            We have sent a verification link to your email address. Please click the link to verify your account before signing in.
          </p>
          <Link
            to="/signin"
            className="inline-block bg-[#D4755B] text-white font-manrope font-bold py-3 px-8 rounded-xl hover:bg-[#C05621] transition-all"
          >
            Go to Sign In
          </Link>
        </div>
        ...
        <div className="bg-white border border-[#E6E0DA] rounded-2xl p-8 shadow-xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="font-manrope font-extralight text-sm text-[#4B5563]">
              Join PlotFarm and find your dream home
            </p>
          </div>
