...
# PlotFarm Backend Quick Setup Script
# This script helps you set up the PlotFarm backend quickly
...
# Header
print_header "🏠 PlotFarm Backend Setup"
print_header "============================"
echo ""
...
MONGO_URI=mongodb://localhost:27017/plotfarm
