...
<body>
  <div class="dash">
    ...
    <!-- Footer -->
    <div class="ftr">
      <p>&copy; ${new Date().getFullYear()} PlotFarm &nbsp;|&nbsp;
        <a href="/health">Health</a> &nbsp;|&nbsp;
        <a href="/status">Status</a> &nbsp;|&nbsp;
        <a href="https://plotfarm.vercel.app" target="_blank">Website</a> &nbsp;|&nbsp;
        <a href="https://github.com/krishna-Agrawal23/PlotFarm" target="_blank">GitHub</a>
      </p>
