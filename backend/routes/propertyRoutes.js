...
router.post('/user/properties', protect, upload.array('images', 8), createUserListing);
router.get('/user/properties', protect, getUserListings);
router.put('/user/properties/:id', protect, upload.array('images', 8), updateUserListing);
