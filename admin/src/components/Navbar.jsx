      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-2">
            ...
            <div className="relative">
              <motion.button
                onClick={toggleNotifications} // MUST HAVE THIS
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              ...
              <AnimatePresence>
                {isNotificationsOpen && (
                  <motion.div
                    ...
                    exit={{ opacity: 0, scale: 0.95, y: -8 }}
                    transition={{ duration: 0.15 }}
                    className="absolute right-0 mt-2 w-72 bg-[#1C1B1A] border border-white/10 rounded-xl shadow-2xl py-2 overflow-hidden z-50"
                  >
                    <div className="px-4 py-3 border-b border-white/10">
                      <div className="text-sm font-semibold text-[#FAF8F4]">Notifications</div>
                    </div>
                    <div className="p-4 text-center">
                      <Bell className="h-8 w-8 text-[#9CA3AF] mx-auto mb-2 opacity-50" />
