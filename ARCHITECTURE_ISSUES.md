# PlotFarm - Architecture Issues Document

> **Project:** PlotFarm
> **GitHub:** [github.com/krishna-Agrawal23/PlotFarm](https://github.com/krishna-Agrawal23/PlotFarm)
...
|---------|-------|----------|
| Auth Token | `token` | `plotfarme_token` |
| Admin Flag | `isAdmin` | N/A |
| User Data | N/A | `plotfarme_user` |
...
- ✅ Service metadata (`plotfarme-api`)
...
FRONTEND_URL=https://plotfarme.vercel.app
ADMIN_URL=https://plotfarm-admin.onrender.com
WEBSITE_URL=https://plotfarm.vercel.app
```

### Frontend (Vercel)
```bash
VITE_API_BASE_URL=https://https://plotfarm.onrender.com
VITE_ENABLE_AI_HUB=true
```

### Admin (Vercel)
```bash
VITE_BACKEND_URL=https://https://plotfarm.onrender.com
```
