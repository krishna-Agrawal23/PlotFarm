...
class EmailService {
  constructor() {
    this.fromAddress = process.env.EMAIL_USER || 'noreply@PlotFarm.com';
  }
  ...
  async sendWelcomeEmail(userEmail, userName) {
    const subject = 'Welcome to PlotFarm - Your Account is Ready!';
  ...
  async sendEmailVerification(userEmail, userName, verificationUrl) {
    const subject = 'Verify Your PlotFarm Email Address';
  ...
  async sendPasswordResetEmail(userEmail, resetUrl) {
    const subject = 'Reset Your PlotFarm Password';
  ...
  async sendNewsletterWelcome(userEmail) {
    const subject = 'Welcome to PlotFarm Newsletter 📧';
  ...
  async sendUserSuspended(userEmail, userName, days, reason, suspendedUntil) {
    const subject = `PlotFarm Account Suspended - ${days} Day${days > 1 ? 's' : ''}`;
  ...
  async sendUserBanned(userEmail, userName, reason) {
    const subject = 'PlotFarm Account Permanently Banned';
  ...
  async sendUserReactivated(userEmail, userName) {
    const subject = 'PlotFarm Account Reactivated - Welcome Back!';
