...
const login = async (req, res) => {
  try {
    ...
    if (!Registeruser.isEmailVerified && !isLegacyUser) {
      ...
      // FIX: ALWAYS generate a new token and RESEND the email if they try to log in while unverified.
      // This prevents accounts from getting permanently stuck if the first email failed to deliver.
      ...
      return res.json({
        message: "Your email is not verified yet. We have just resent a new verification link to your inbox!",
        success: false,
