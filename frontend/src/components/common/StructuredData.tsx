...
const SITE_URL = 'https://PlotFarm.vercel.app';
...
const StructuredData: React.FC<StructuredDataProps> = ({ type, data }) => {
  ...
  const schemas: Record<string, object> = {
    ...
    organization: {
      ...
      sameAs: [
        'https://github.com/krishna-Agrawal23/PlotFarm',
        'https://linkedin.com/in/krishna-agrawal10',
      ],
      contactPoint: {
        '@type': 'ContactPoint',
