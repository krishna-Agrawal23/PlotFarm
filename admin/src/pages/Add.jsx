    ...
    <div className="min-h-screen pt-8 pb-12 px-4 bg-[#FAF8F4]">
      <div className="max-w-3xl mx-auto">
        ...
        >
          ...
          <p className="text-[#5A5856]">Fill in the details to list a new property on PlotFarm</p>
        </motion.div>
        ...
        >
            ...
            <div className="grid grid-cols-3 gap-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="number" id="beds" name="beds" required={formData.type !== 'Plot'} min="0"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="number" id="baths" name="baths" required={formData.type !== 'Plot'} min="0"
          ...
          {/* Image Upload */}
          <div className="bg-white rounded-2xl p-6 border border-[#E6D5C3] shadow-card">
            <SectionHeader icon={Upload} title="Property Images" subtitle={`${previewUrls.length}/8 images uploaded`} />
